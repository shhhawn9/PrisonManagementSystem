...
<div class="flexbox-container">
    <div class="flex-item">
        <div id="page-container">
            ...
            <form method="post" action="rpSystem_reward.php">
                <p><div class="enterPrisoner">Please enter the prisoner id you want to reward:</div></p>
                <p><label class="label_input">Prisoner:</label><input type="text" name="prisoner" class="text_field"/></p>
                <div id="login_control">
                    <input class="submitButton" type="submit" value="Reward">
...
if (isset($_POST['prisoner'])) {
    ...
    $sql1 = "INSERT INTO `Reward_and_punishment` (`RP_ID`, `Description`) VALUES (NULL, 'Reward')";
    ...
    echo "successfully reward the prisoner";
    CloseCon($conn);
